...
>(({ id, className, children, config, ...props }, ref) => {
  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div data-chart={chartId} ref={ref} className={classNames(styles.container, className)} {...props}>
...
>(
  (
    { active, payload, className, indicator = "dot", hideLabel, hideIndicator, labelFormatter, formatter, ...props },
    ref
  ) => {
