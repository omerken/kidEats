...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={classNames(styles.menuBadge, className)}
    {...props}
  />
));
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={classNames(styles.menuSkeleton, className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={classNames(styles.menuSub, className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <li
    ...
    className={classNames(styles.menuSubItem, className)}
    {...props}
  />
));
